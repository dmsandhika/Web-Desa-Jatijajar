...
class DataSuratController extends Controller
{
    ...
    public function diajukan(){
        ...
        $data = $belumNikah->union($domisili)->where('status', 'diajukan')->orderBy('created_at')->get();
    ...
    public function ditolak(){
        ...
        $data = $belumNikah->union($domisili)->where('status', 'ditolak')->orderBy('created_at')->get();
    ...
    public function selesai(){
        ...
        $data = $belumNikah->union($domisili)->where('status', 'selesai')->orderBy('created_at')->get();
