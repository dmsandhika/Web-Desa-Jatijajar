<x-layout-admin>
  ...
  <form id="rekomendasiForm" action="{{ route('surat.rekomendasi.update', $data->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
      ...
      <div class="border-b border-gray-900/10 pb-12 ">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <input type="number" name="nik" id="nik" value="{{ $data->nik }}" readonly class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>
          ...
          <div class="col-span-full">
            <label for="rekomendasi" class="block text-sm font-medium leading-6 text-gray-900">Isi Rekomendasi</label>
            <div class="mt-2">
              <textarea id="rekomendasi" name="rekomendasi" readonly rows="3" class="block w-full px-1.5 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $data->rekomendasi }}</textarea>
            </div>
          </div>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <textarea id="keperluan" name="keperluan" readonly rows="3" class="block w-full px-1.5 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $data->keperluan }}</textarea>
            </div>
          </div>
