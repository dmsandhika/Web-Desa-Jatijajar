      ...
      <div class="border-b border-gray-900/10 pb-12">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <img src="{{ asset($data->kk) }}" alt="Foto KTP" class="h-40 w-auto object-cover cursor-pointer" onclick="openFullScreen('{{ asset($data->kk) }}')">
            </div>
          </div>
        </div>
        ...
        <div class="col-span-full  mt-6">
          <label for="file" class="block text-sm font-medium leading-6 text-gray-900">File Surat</label>
          <div class="mt-2">
            @if($data->file)
