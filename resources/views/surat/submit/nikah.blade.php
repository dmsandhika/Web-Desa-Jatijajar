<x-layout-admin>
    ...
    <form
        id="nikahForm"
        action="{{ route("surat.nikah.update", $data->id) }}"
        method="POST"
                ...
                >
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->ktp_pemohon) }}"
                                    alt="Foto KTP Pemohon"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->ktp_pemohon) }}')"
                                />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->ktp_ayah) }}"
                                    alt="Foto KTP Ayah"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->ktp_ayah) }}')"
                                />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->ktp_ibu) }}"
                                    alt="Foto KTP Ibu"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->ktp_ibu) }}')"
                                />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->ktp_calon) }}"
                                    alt="Foto KTP Calon"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->ktp_calon) }}')"
                                />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->kk_pemohon) }}"
                                    alt="Foto KK Pemohon"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->kk_pemohon) }}')"
                                />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->kk_calon) }}"
                                    alt="Foto KK Calon"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->kk_calon) }}')"
                                />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <input
                                ...
                                value="{{ $data->tgl }}"
                                readonly
                                class="block w-1/6 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            />
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->ktp_wali) }}"
                                    alt="Foto KTP Wali"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->ktp_wali) }}')"
                                />
                            @endif
                        </div>
                    </div>
