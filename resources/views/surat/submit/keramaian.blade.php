<x-layout-admin>
  ...
  <form id="keramaianForm" action="{{ route('surat.keramaian.update', $data->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
      ...
      <div class="border-b border-gray-900/10 pb-12">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <input type="text" placeholder="NIK" name="nik" id="nik" value="{{ $data->nik ?? '' }}" readonly autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <input type="text" name="nama" id="nama" placeholder="Nama Lengkap" value="{{ $data->nama ?? '' }}" readonly autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <input type="text" name="acara" id="acara" placeholder="Nikahan, Dll" value="{{ $data->acara ?? '' }}" readonly autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>
          ...
          <div class="col-span-full flex items-center space-x-4">
            <div class="w-1/6">
              ...
              <div class="mt-2">
                <input type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ $data->tanggal_mulai ?? '' }}" readonly autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              </div>
            </div>
            <div class="w-1/12">
              <label for="jam_mulai" class="block text-sm font-medium leading-6 text-gray-900">Jam Mulai</label>
              <div class="mt-2">
                <input type="time" name="jam_mulai" id="jam_mulai" value="{{ $data->jam_mulai ?? '' }}" readonly autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              </div>
            </div>
          </div>
          ...
          <div class="col-span-full flex items-center space-x-4">
            <div class="w-1/6">
              ...
              <div class="mt-2">
                <input type="date" name="tanggal_berakhir" id="tanggal_berakhir" value="{{ $data->tanggal_berakhir ?? '' }}" readonly autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              </div>
            </div>
            <div class="w-1/12">
              <label for="jam_berakhir" class="block text-sm font-medium leading-6 text-gray-900">Jam Berakhir</label>
              <div class="mt-2">
                <input type="time" name="jam_berakhir" id="jam_berakhir" value="{{ $data->jam_berakhir ?? '' }}" readonly autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              </div>
            </div>
          </div>
          ...
          <div class="col-span-full mt-6">
            ...
            <div class="mt-2">
              <input type="text" name="hiburan" id="hiburan" value="{{ $data->hiburan ?? '' }}" readonly autocomplete="off" placeholder="Jenis Hiburan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <textarea id="lokasi" name="lokasi" placeholder="Masukkan Alamat..." rows="3" readonly class="block px-1.5 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $data->lokasi ?? '' }}</textarea>
            </div>
          </div>
          ...
          <div class="col-span-full mt-6">
            ...
            <div class="mt-2">
              <input type="number" name="no" id="no" value="{{ $data->no ?? '' }}" readonly autocomplete="off" placeholder="Masukkan Nomor" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>
          <div class="col-span-full  mt-6">
