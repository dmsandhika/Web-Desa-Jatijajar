<x-layout-admin>
  ...
  <form id="hasilForm" action="{{ route('surat.penghasilan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="space-y-12 ">
      <div class="border-b border-gray-900/10 pb-12 ">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="col-span-full">
            <label for="gaji" class="block text-sm font-medium leading-6 text-gray-900">Rata-rata Penghasilan per Bulan</label>
            <div class="mt-2">
              <input type="number" name="gaji" id="gaji" value="{{ $data->gaji }}" readonly class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>
