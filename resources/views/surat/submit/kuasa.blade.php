<x-layout-admin>
    ...
    <form
        id="kuasaForm"
        action="{{ route("surat.kuasa.update", $data->id) }}"
        method="POST"
    ...
    >
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-xl font-medium leading-6 text-gray-900 mt-5">
                    Pemberi Kuasa
                </h2>
                ...
                >
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->ktp_pemberi) }}"
                                    alt="Foto KTP Pemberi Kuasa"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->ktp_pemberi) }}')"
                                />
                            @endif
                        </div>
                    </div>
                ...
                >
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <img
                                    src="{{ asset($data->ktp_penerima) }}"
                                    alt="Foto KTP Penerima Kuasa"
                                    class="h-40 w-auto object-cover cursor-pointer"
                                    onclick="openFullScreen('{{ asset($data->ktp_penerima) }}')"
                                />
                            @endif
                        </div>
                    </div>
