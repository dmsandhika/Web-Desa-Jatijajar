<x-layout>
    ...
    <div id="default-carousel" class="relative w-full" data-carousel="slide">
        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img
                    src="img/carousel/kuda.jpeg"
                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                    alt="Kuda"
                />
                <div
                    class="absolute w-full text-center text-white flex justify-center items-center h-full"
                >
                    <div>
                        ...
                        <p class="text-xl">
                            Kuda sedang menikmati waktu di padang rumput.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                >
                    <div>
                        ...
                        <p class="text-xl">
                            Pemandangan indah danau saat matahari terbenam.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                >
                    <div>
                        ...
                        <p class="text-xl">
                            Kuda berlari dengan bebas di alam terbuka.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                >
                    <div>
                        ...
                        <p class="text-xl">
                            Kuda menikmati senja di padang rumput.
                        </p>
                    </div>
                </div>
            </div>
    ...
    >
        ...
        <a
            href="/profil"
            class="hover:-translate-y-2 group bg-neutral-50 duration-500 w-44 h-32 flex text-neutral-600 flex-col justify-center items-center relative rounded-xl overflow-hidden shadow-md"
        >
            <svg
                viewBox="0 0 200 200"
                xmlns="http://www.w3.org/2000/svg"
    ...
    <div>
        <h1 class="flex items-center text-3xl mt-6 font-bold dark:text-white">
            Artikel Terbaru
        </h1>
