...
<div>
    <h3 class="mb-4 mt-6 pt-6 text-4xl font-extrabold leading-none tracking-tight text-center text-gray-900 md:text-5xl lg:text-3xl dark:text-white">
    ...
    <p class="text-lg font-normal text-center text-gray-500 lg:text-l dark:text-gray-400">
...
<div>
    <h3 class="mb-4 mt-6 pt-6 text-3xl font-bold leading-none tracking-tight text-gray-700 md:text-5xl lg:text-2xl dark:text-white">
...
<div class="flex flex-col lg:flex-row items-start lg:items-start mt-4">
    <div class="lg:w-2/3 lg:pr-4">
        <p class="text-lg font-normal text-gray-500 lg:text-l dark:text-gray-400 text-justify">
